...
async def _(event):
    ...
    await event.delete()
    await event.reply("**NGEBANN SI KONTOLLL INI...**")
    asyncio.sleep(3.5)
    await event.edit(f"**MAMPUSSS GUA BAN by {DEFAULTUSER}**")
    asyncio.sleep(5)
    await event.delete()
...
async def _(event):
    ...
    await event.delete()
    await event.reply("**SI KONTOLL PENGN NIMB LGI...**")
    asyncio.sleep(3.5)
    await event.edit(f"**RUSUH LAGI GUA BANN LU KONTOLL by {DEFAULTUSER}**")
    asyncio.sleep(5)
    await event.delete()
